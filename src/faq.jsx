...
const content = [
    ...
    },
    {
        ...
        message: "Ja, als je dit venster sluit wordt je laatste invoer bewaard." + "\n" +
            ...
            "of een data bestand te downloaden die lokaal kunt bewaren op je apparaat."
    },
    {
    ...
    },
    {
        ...
        message: "Ja, als je het personage na invoer bewaard, kun je het daarna gewoon weer inladen." + "\n" +
            ...
            "Wil je deze wijzigingen opslaan, vergeet dan niet de naam eerst te wijzigen!"
    },
    {
        header: "Kan ik mijn personage nog wijzigen nadat ik het ge-exporteerd heb ?",
        message: "Ja, als je het personage geexporteerd hebt, kun je het daarna gewoon weer uploaden." + "\n" +
            "Je mag dan wijzigingen aanbrengen aan het personage, maarrr..." + "\n" +
            "Let op: dit heeft geen effect op het lokale bestand!" + "\n" +
            "Je zal de gewijzigde versie weer moeten exporteren!"
    },
    {
    ...
    },
    {
        ...
        message: "Per evenement die het personage volledig heeft overleeft ontvangt je personage XP." + "\n" +
            ...
            "https://the-vortex.nl/wp-content/uploads/2022/04/Vaardigheden.pdf#page=40"
    },
    {
        header: "Wat is het verschil tussen Basis- en Extra vaardiheden ?",
        message: "Wanneer je een personage start, mogen alleen Basisvaarigheden gekozen worden." + "\n" +
    ...
    },
    {
        ...
        message: "We horen graag van je waar we je mee kunnen helpen." + "\n" +
            ...
            "Regelsysteemvragen" + "\n" +
            "https://discord.com/channels/887411615178293298/1119280489140846754"
    },
    {
    ...
    },
    {
        ...
        message: "Dat is vervelend. Uiteraard willen we dit voor je oplossen!" + "\n" +
            ...
            "Meldt deze dan op de VA Discord in het kanaal:" + "\n" +
            "Website-feedback" + "\n" +
            "https://discord.com/channels/887411615178293298/889812948514639893"
    },
    {
        header: "Tijdens het inladen krijg ik een melding dat de regelset versie niet herkent wordt.",
        message: "Dat is vervelend. Mogelijk heb je een oudere versie van een personage in proberen te laden." + "\n" +
    ...
    {
        header: "Tijdens het inladen krijg ik een melding dat de regelset versie niet ingelezen kan worden.",
        message: "Dat is vervelend. Mogelijk heb je een corrupte of verouderde versie van een personage in proberen te laden." + "\n" +
            "Elk personage wordt opgeslagen met benoeming van een regelset versie en aanvullende details." + "\n" +
            "Hiermee voorkomen we foutief samengestelde personages." + "\n" +
            "Het personage wat je hebt gekozen voldoent niet (meer) aan deze standaard." + "\n" +
    ...
    },
    {
        ...
        message: "Dat is vervelend. Mogelijk is er iets niet goed aan het bestand dat je probeert in te laden." + "\n" +
            ...
            "We raden je aan de inhoud van opgeslagen of geexporteerde personages niet te wijzigen."
    }
]
